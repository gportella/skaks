...
inline constexpr std::string_view kEngineVersion = "0.6";

inline constexpr std::array<std::string_view, 11> kOptimizationFeatures{
    ...
    "Null move pruning + historical heuristic",
};
